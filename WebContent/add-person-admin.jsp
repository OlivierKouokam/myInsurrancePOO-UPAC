                                    ...
                                    <div class="p-5">
                                        ...
                                        <form action="addperson.do" method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="nom" type="text" placeholder="Nom" name="nom" required="required">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="prenom">Prenom</label>
                                                <input class="form-control" id="prenom" type="text" placeholder="Prenom" name="prenom" required="required">
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              <div id="isassure" class="btn-group" data-toggle="buttons">
                                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                  <input type="radio" name="isassure" value="oui"> &nbsp; Oui &nbsp;
                                                </label>
                                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default" style="margin-bottom: 15px;">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                              ...
                                              <div class="form-group">
                                                <label for="nomcabinet">Nom du Cabinet</label>
                                                <input class="form-control" id="nomcabinet" type="text" placeholder="Cabinet" name="nomcabinet">
                                            </div>
                                            <div class="form-group">
                                                <label for="phonecabinet">Numéro du Cabinet</label>
