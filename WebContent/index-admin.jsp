                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ---</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="add-person-admin.jsp"> AJOUTER UNE PERSONNE</a></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a href="assign-medecin-admin.jsp">ASSIGNER UN MEDECIN TRAITANT</a></div>
                                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ---</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="remboursement-admin.jsp">EFFECTUER UN REMBOURSEMENT</a></div>
                                        </div>
                                        <div class="col-auto">
