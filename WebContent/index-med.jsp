                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ---</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="liste-patient-med.jsp"> LISTE DES PATIENTS</a></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a href="consultation-med.jsp">EFFECTUER UNE CONSULTATION</a></div>
                                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ---</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><a href="list-consultation-med.jsp">LISTE DES CONSULTATIONS</a></div>
                                        </div>
                                        <div class="col-auto">
